(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueContainerQuery"] = factory();
	else
		root["VueContainerQuery"] = factory();
...
// EXTERNAL MODULE: ./node_modules/container-query-toolkit/lib/matchQueries.js
var matchQueries = __webpack_require__("1b47");
var matchQueries_default = /*#__PURE__*/__webpack_require__.n(matchQueries);
...
var lib = __webpack_require__("a307");
...
// CONCATENATED MODULE: ./src/components/isShallowEqual.js



var isShallowEqual_hasOwnProperty = Object.prototype.hasOwnProperty;
function isShallowEqual(paramA, paramB) {
  ...
  for (var i = 0; i < keysA.length; i++) {
    if (!isShallowEqual_hasOwnProperty.call(paramB, keysA[i]) || paramA[keysA[i]] !== paramB[keysA[i]]) {
      return false;
    }
  }
...
// CONCATENATED MODULE: ./src/components/ContainerQueryCore.js
...
var ContainerQueryCore_ContainerQueryCore =
/*#__PURE__*/
function () {
  function ContainerQueryCore(query, callback) {
    var _this = this;

    _classCallCheck(this, ContainerQueryCore);

    this.result = {};
    this.rol = new lib_default.a(function (size) {
      var result = matchQueries_default()(query)(size);

      if (!isShallowEqual(_this.result, result)) {
        callback(result);
        _this.result = result;
      }
    });
  ...
  _createClass(ContainerQueryCore, [{
    key: "observe",
...
/* harmony default export */ var Base = ({
  methods: {
    ...
    disposeObserver: function disposeObserver() {
      if (this.cqCore) {
    ...
    startObserving: function startObserving(query) {
      var _this = this;

      this.cqCore = new ContainerQueryCore_ContainerQueryCore(query, function (params) {
        _this.handleChange(params);
      });
      var element = this.$el || this.$slots.default[0].elm;
  ...
  created: function created() {
    ...
    var params = initialSize ? matchQueries_default()(query)(initialSize) : {};
...
// CONCATENATED MODULE: ./src/components/isQueriesEqual.js




var isQueriesEqual_hasOwnProperty = Object.prototype.hasOwnProperty;
function isQueriesEqual(queryA, queryB) {
  ...
  for (var i = 0; i < keysA.length; i++) {
    if (!isQueriesEqual_hasOwnProperty.call(queryB, keysA[i]) || !isShallowEqual(queryA[keysA[i]], queryB[keysA[i]])) {
      return false;
    }
  }
...
var kErrMsg = '<vue-Container-query> can only render' + ' one, and exactly one child component';
var ContainerQuery = {
...
function createContainerQueryMixin(query, initialSize) {
  return {
    mixins: [Base],
    data: function data() {
      return {
...
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "ContainerQuery", function() { return ContainerQuery; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "createContainerQueryMixin", function() { return createContainerQueryMixin; });
...
//# sourceMappingURL=VueContainerQuery.umd.js.map