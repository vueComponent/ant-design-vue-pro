...
If you have any comment or advice, please report your [issue](https://github.com/antvis/attr/issues),
or make any change as you wish and submit an [PR](https://github.com/antvis/attr/pulls).
...
Then you can create a Pull Request at [attr](https://github.com/antvis/attr/pulls).
...
4. User Tips: Notice for attr users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
Document change on antvis/attr#123
...
attr uses semantic versioning in release process based on [semver].
