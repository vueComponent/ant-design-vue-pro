...
If you have any comment or advice, please report your [issue](https://github.com/antvis/component/issues),
or make any change as you wish and submit an [PR](https://github.com/antvis/component/pulls).
...
Then you can create a Pull Request at [component](https://github.com/antvis/component/pulls).
...
4. User Tips: Notice for component users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
Document change on antvis/component#123
...
component uses semantic versioning in release process based on [semver].
