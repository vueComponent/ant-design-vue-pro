...
If you have any comment or advice, please report your [issue](https://github.com/antvis/hierarchy/issues),
or make any change as you wish and submit an [PR](https://github.com/antvis/hierarchy/pulls).
...
Then you can create a Pull Request at [hierarchy](https://github.com/antvis/hierarchy/pulls).
...
4. User Tips: Notice for hierarchy users. You can skip this part, if the PR is not about update in API or potential compatibility problem.
...
Document change on antvis/hierarchy#123
...
hierarchy uses semantic versioning in release process based on [semver].
