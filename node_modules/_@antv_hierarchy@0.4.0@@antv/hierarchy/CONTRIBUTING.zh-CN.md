...
有任何疑问，欢迎提交 [issue](https://github.com/antvis/hierarchy/issues)，
或者直接修改提交 [PR](https://github.com/antvis/hierarchy/pulls)!
...
提交后就可以在 [hierarchy](https://github.com/antvis/hierarchy/pulls) 创建 Pull Request 了。
...
Document change on antvis/hierarchy#12
...
hierarchy 基于 [semver] 语义化版本号进行发布。
