    ...
    <a-card :bordered="false" class="card-box">
      <a-row :gutter="8">
        ...
        <a-col :span="19" style="height:100%;">
          <a-form :form="form" @submit="handleSubmit" :layout="formLayout" style="height:100%;overflow:hidden auto;-ms-overflow-x: hidden;">
            ...
            <div class="baselineForm" :style="baselineFormStyle">
              ...
              <a-form-item class="font-w" label="(9) 小结：根据实验室检查及既往病史判断(多选):" :labelCol="{md: 20}" :wrapperCol="wrapperHor">
