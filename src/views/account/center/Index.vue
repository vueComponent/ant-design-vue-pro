       ...
       <a-col :span="19">
        <a-form :form="form" @submit="handleSubmit">
         ...
         <div class="baselineForm" :style="baselineFormStyle">
            ...
            <a-form-item label="(1) 留全血:" :labelCol="labelColHor" :wrapperCol="labelColHor">
              <a-radio-group v-decorator="['question1', {rules: [{required: true, message: '请选择是或否！'}]}]">
                <a-radio value="1">是</a-radio>
                <a-radio value="-1">否</a-radio>
              </a-radio-group>
            </a-form-item>
            <a-form-item label="(1) 留血清:" :labelCol="labelColHor" :wrapperCol="labelColHor">
              <a-radio-group v-decorator="['question2', {rules: [{required: true, message: '请选择是或否！'}]}]">
                <a-radio value="1">是</a-radio>
                <a-radio value="-1">否</a-radio>
              </a-radio-group>
            </a-form-item>
