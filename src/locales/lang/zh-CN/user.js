export default {
  ...
  'user.login.acc.placeholder.org': '账号或学生组织名称',
  'user.login.acc.placeholder.org.forget': '账号(非组织名称)',
  'user.login.acc.placeholder.admin': '账号',
  'user.login.psw.placeholder.org': '密码',
  'user.login.psw.placeholder.admin': '密码',
  'user.login.remember.me': '自动登录',
  'user.login.main.button': '登 录',
  'user.login.forget.button': '确 定',
  'user.login.forget.password': '重置密码',
  'user.login.forget.back': '返回',
  'layouts.userLayout.footer.help': '帮助',
  'layouts.userLayout.footer.privacy': '隐私',
  'layouts.userLayout.footer.agreements': '条款',
  'layouts.userLayout.name': '济星云中台',
  'user.login.tab-login-credentials': '恒星号登录',
  'user.login.tab-login-mobile': '管理员登录',
  ...
  'user.org.userName.required': '请输入恒星号帐号或注册学生组织名称！',
  'user.org.userName.required.forget': '请输入恒星号帐号！',
  'user.admin.userName.required': '请输入管理员账号！',
