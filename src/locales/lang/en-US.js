...
const locale = {
  ...
  'menu.account.settings.base': 'Base Settings',
  'menu.account.settings.security': 'Security Settings',
  'menu.account.settings.custom': 'Custom Settings',
  'menu.account.settings.binding': 'Account Binding',
  'menu.account.settings.notification': 'Message Notification',
  ...
  'app.setting.production.hint': 'Setting panel show in development enviorment only, please mannually modify',
  'message': '-',
