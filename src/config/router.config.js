...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // vue 练习 practice
      // 显示不出来是因为权限问题 permission
      // 需要配置的文件
      // config\route.config.js
      // router\generator-routers.js
      // mock数据 mock\services\user.js
      // 国际化 locales\lang\zh-CN\menu.js、locales\lang\en-US\menu.js
      {
        path: '/Practice',
        name: 'practice',
        component: RouteView,
        redirect: '/practice/classOne',
        meta: { title: 'menu.practice', icon: 'check-circle-o', permission: ['practice'] },
        children: [
          {
            path: '/practice/classOne',
