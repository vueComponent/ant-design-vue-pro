      ...
      // dashboard
      {
        ...
        children: [
          ...
          // 外部链接
          {
            path: 'https://www.baidu.com/',
            name: 'Monitor',
            meta: { title: 'Monitor（outside）', target: '_blank' }
          },
          {
            path: '/dashboard/workplace',
            name: 'Workplace',
        ...
        children: [
          {
            ...
            meta: { title: 'Search Table', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/list/basic-list',
            name: 'BasicList',
        ...
        children: [
          {
            ...
            name: 'ProfileBasic',
            component: () => import('@/views/profile/basic/Index'),
            meta: { title: 'Basic Profile', permission: ['profile'] }
          },
          {
            path: '/profile/advanced',
            name: 'ProfileAdvanced',
            component: () => import('@/views/profile/advanced/Advanced'),
            meta: { title: 'Advanced Profile', permission: ['profile'] }
          }
        ]
      },
      ...
      // account
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'settings',
            component: () => import('@/views/account/settings/Index'),
            meta: { title: 'Account Settings', hideHeader: true, permission: ['user'] },
            redirect: '/account/settings/base',
            hideChildrenInMenu: true,
            children: [
              {
                ...
                name: 'BaseSettings',
                component: () => import('@/views/account/settings/BaseSetting'),
                meta: { title: 'Basic setting', hidden: true, permission: ['user'] }
              },
              {
                path: '/account/settings/security',
                name: 'SecuritySettings',
                component: () => import('@/views/account/settings/Security'),
                meta: { title: 'Safe setting', hidden: true, keepAlive: true, permission: ['user'] }
              },
              {
                path: '/account/settings/custom',
                name: 'CustomSettings',
                component: () => import('@/views/account/settings/Custom'),
                meta: { title: 'Personalized setting ', hidden: true, keepAlive: true, permission: ['user'] }
              },
              {
                path: '/account/settings/binding',
                name: 'BindingSettings',
              ...
              },
              {
                ...
                name: 'NotificationSettings',
                component: () => import('@/views/account/settings/Notification'),
                meta: { title: 'New Message', hidden: true, keepAlive: true, permission: ['user'] }
              }
            ]
          }
        ]
            ...
            children: [
              {
                ...
                name: 'TreeList',
                component: () => import('@/views/other/TreeList'),
                meta: { title: 'Tree catalog table', keepAlive: true }
              },
              {
                path: '/other/list/edit-table',
                name: 'EditList',
                component: () => import('@/views/other/TableInnerEditList'),
                meta: { title: 'Inline editing table', keepAlive: true }
              },
              {
                path: '/other/list/user-list',
                name: 'UserList',
...
export {
  asyncRouterMap, asyncRouterMapEn, constantRouterMap
}
