    ...
    >
      <div class="setting-drawer-index-content">
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">{{$t('lang.appsettingpagestyle')}}</h3>
          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              <template slot="title">{{$t('lang.appsettingpagestyledark')}}</template>
            ...
            <a-tooltip>
              <template slot="title">{{$t('lang.appsettingpagestylelight')}}</template>
        ...
        <div :style="{ marginBottom: '24px' }">
          <h3 class="setting-drawer-index-title">{{$t('lang.appsettingthemecolor')}}</h3>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <div class="setting-drawer-index-blockChecbox">
            <a-tooltip>
              <template slot="title">{{$t('lang.appsettingsidemenu')}}</template>
            ...
            <a-tooltip>
              <template slot="title">{{$t('lang.appsettingtopmenu')}}</template>
            ...
            <a-list :split="false">
              <a-list-item>
                <a-tooltip slot="actions">
                  ...
                  >
                    <a-select-option value="Fixed">{{$t('lang.appsettingcontentwidthfixed')}}</a-select-option>
                    <a-select-option
                      value="Fluid"
                      v-if="layoutMode !== 'sidemenu'"
                    >{{$t('lang.appsettingcontentwidthfluid')}}</a-select-option>
                  </a-select>
                </a-tooltip>
                <a-list-item-meta>
                  <div slot="title">{{$t('lang.appsettingcontentwidth')}}</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                <a-switch
                ...
                />
                <a-list-item-meta>
                  <div slot="title">{{$t('lang.appsettingfixedheader')}}</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                <a-switch
                ...
                <a-list-item-meta>
                  <a-tooltip slot="title" placement="left">
                    <template slot="title">{{$t('lang.appsettinghideheaderhint')}}</template>
                    <div
                      :style="{ opacity: !fixedHeader ? '0.5' : '1' }"
                    >{{$t('lang.appsettinghideheader')}}</div>
                  </a-tooltip>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                ...
                <a-list-item-meta>
                  ...
                  >{{$t('lang.appsettingfixedsidebar')}}</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
          ...
          <div>
            <a-list :split="false">
              <a-list-item>
                ...
                />
                <a-list-item-meta>
                  <div slot="title">{{$t('lang.appsettingweakmode')}}</div>
                </a-list-item-meta>
              </a-list-item>
              <a-list-item>
                <a-switch
                ...
                />
                <a-list-item-meta>
                  <div slot="title">{{$t('lang.appsettingMultiPageMode')}}</div>
                </a-list-item-meta>
              </a-list-item>
            </a-list>
          </div>
        ...
        <div :style="{ marginBottom: '24px' }">
          ...
          <a-alert type="warning" :style="{ marginTop: '24px' }">
            <span slot="message">
              {{$t('lang.appsettingproductionhint')}}
              <a
...
import { updateTheme, updateColorWeak, colorList, colorListEn } from './settingConfig'
